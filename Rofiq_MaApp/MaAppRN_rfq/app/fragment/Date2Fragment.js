...
export function update_ui(d2) {
  ...
  mDate = new Date(d2);
  console.log('called update_ui: ' + mDate.toString());
}

const Date2Fragment = ({callback}) => {
  console.log("called Date2Fragment default func");
  // var mDate = new Date();
    ...
    return (
      <View>
        <Text style={styles.dateShow}>
          {/* {day}/{month}/{year} */}
          {mDate.toString().substr(4, 6)}, {mDate.toString().substr(11, 4)}
        </Text>
        {show && (
          <DateTimePicker2
